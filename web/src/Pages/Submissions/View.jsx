...
export default function SubmissionsView() {
  ...
  function translateSubmission({assignment_name, assignment_due, id, processed, state, created}) {
    return {
      assignmentName: assignment_name, assignmentDue: new Date(assignment_due), state: state,
      submissionId: id, processed: processed, timeSubmitted: created.split(' ')[0],
                ...
                <TableBody>
                  {(rowsPerPage > 0
                    ...
                    <TableRow key={row.name} hover={true}
                              ...
                              to={`/courses/assignments/submissions/info?submission=${row.submissionId}`}>
                      <TableCell style={{width: 160}}>
                        {row.assignmentName}
                      </TableCell>
                      <TableCell style={{width: 160}}>
                        {row.submissionId.substr(0, 10)}
                      </TableCell>
